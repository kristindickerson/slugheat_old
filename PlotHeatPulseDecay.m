...
function [h_axHPTempvTime, ...
    ...
    % ---------------------------------------------
        ...
        ymaxAll = max(ymax);
            ...
            % ---------------------------
            xlabel(axes_CTempvCtime, 'Corrected Time (s)', 'verticalalignment','top', ...
            'fontsize',16)
            ylabel(axes_CTempvCtime, 'Corrected Temperature Rise ( ^oC)', 'verticalalignment',...
                'bottom', 'fontsize',16)
    ...
    % ------------------------------------------------
        ...
        % --------------------------
          xlabel(axes_CTempv1_CTime, '1/Time (s^{-1})', ...
            'verticalalignment','top', ...
            'fontsize',16)
          ylabel(axes_CTempv1_CTime, 'Corrected Temperature Rise ( ^oC)', ...
