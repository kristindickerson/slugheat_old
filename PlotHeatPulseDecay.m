...
function [h_axHPTempvTime, ...
    ...
    % -------------------------------------------------------------
        ...
        % --------------------------
            xlabel(axes_MisfitvTimeShift, '\bfTime Shifts (s)', ...
                ...
                'fontsize',16)
            ylabel(axes_MisfitvTimeShift, '\bfMisfit for k_{slope} (W m^{-1} ^oC^{-1})', ...
                'verticalalignment','top', ...
                'fontsize',16)
        ...
        % --------------------------------------------------------
        legend(axes_MisfitvTimeShift,'Misfit with each time shift','Time shift with minimum misfit',"location","northeast");
    ...
    % --------------------------------------------
        ...
        % (point used for subsequent analyses)
        % --------------------------------------------------------
        legend(axes_TempvTimeShift,'Misfit with each time shift','Time shift with minimum misfit',"location","northeast");
